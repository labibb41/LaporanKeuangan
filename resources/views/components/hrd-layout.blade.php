        ...
        <header class="sticky top-0 z-30 border-b border-slate-200/70 bg-white/95 backdrop-blur-md">
            <div class="flex items-center justify-between gap-4 px-5 py-3 sm:px-7">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-bold text-stone-950" style="font-family:'Montserrat',sans-serif;">{{ config('app.name') }}</p>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div x-data="{ open: false }" @click.outside="open = false" class="relative">
                        <button @click="open = !open"
                            class="inline-flex items-center gap-2 rounded-xl border border-stone-200 bg-white py-1 pl-3 pr-1 text-xs font-bold text-stone-700 shadow-sm hover:border-stone-300 transition">
