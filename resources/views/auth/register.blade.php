<x-guest-layout>
    <div class="mx-auto w-full max-w-md">
        ...
        <div class="mb-6 flex rounded-2xl bg-stone-100 p-1">
            <a href="{{ route('login') }}" class="flex-1 rounded-xl px-4 py-2 text-center text-sm font-semibold text-stone-700 hover:text-stone-950">Login</a>
            <a href="{{ route('register') }}" class="flex-1 rounded-xl bg-stone-950 px-4 py-2 text-center text-sm font-semibold text-amber-300 shadow-sm">Daftar</a>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4" x-on:submit="loading = true">
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <x-text-input id="name" class="block w-full rounded-2xl border-0 bg-stone-100/70 !pl-14 pr-4 py-3 text-sm shadow-none placeholder:text-stone-400 transition focus:bg-white focus:ring-2 focus:ring-amber-500" style="padding-left: 3.5rem;" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Nama lengkap" />
                </div>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <x-text-input id="password_confirmation" class="block w-full rounded-2xl border-0 bg-stone-100/70 !pl-14 pr-4 py-3 text-sm shadow-none placeholder:text-stone-400 transition focus:bg-white focus:ring-2 focus:ring-amber-500" style="padding-left: 3.5rem;" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password" />
                </div>
            ...
            <p class="pt-2 text-center text-sm text-stone-600">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="font-semibold text-amber-700 hover:text-amber-800">Login sekarang</a>
            </p>
        </form>
        </div>
    </div>
